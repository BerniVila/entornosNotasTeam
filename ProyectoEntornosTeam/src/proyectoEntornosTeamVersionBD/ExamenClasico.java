...
public class ExamenClasico extends Examen{
	 ...
	 */
	public ExamenClasico(double porcentaje, double nota, String descripcion) throws notaInvalidoExamenClasicoExcepcion, SinPorcentajeExcepcion, ClassNotFoundException, SQLException {
		super(porcentaje);
