...
public class CalculaNotasGlobalGUI {
	 ...
	 */
	public CalculaNotasGlobalGUI() throws notaInvalidoExamenClasicoExcepcion, notaInvalidoExamenTestExcepcion, niaRepetidoExcepcion, ClassNotFoundException, SQLException, SinPorcentajeExcepcion {
		initialize();
	}
