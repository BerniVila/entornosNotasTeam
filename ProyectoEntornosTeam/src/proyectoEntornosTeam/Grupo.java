...
public class Grupo {
	 ...
	 * @return Devuelve true si la NIA no esta repetido y a�ade el alumno a la lista y false si la NIA ya existe
	...
	/**
	 * 
	 * @return Devuelve una copia de la lista, asi no permite motificar la lista con los m�todos de ArrayList
	 */
