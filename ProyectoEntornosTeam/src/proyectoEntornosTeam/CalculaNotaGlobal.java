...
public class CalculaNotaGlobal {
	...
	public static void main(String[] args) throws SinPorcentajeExcepcion, notaInvalidoExamenClasicoExcepcion, notaInvalidoExamenTestExcepcion, niaRepetidoExcepcion {
