	...
	public static void main(String[] args) throws SinPorcentajeExcepcion, notaInvalidoExamenClasicoExcepcion,
		...
		try {
			daw.addAlumno(new Alumno("1", new ExamenClasico(0.1, 10), new ExamenClasico(0.2, 10),
					new ExamenClasico(0.2, 10), new ExamenTest(0.25, 30, 10), new ExamenTest(0.25, 30, 0),
			...
			daw.addAlumno(new Alumno("5", new ExamenClasico(0.1, 9), new ExamenClasico(0.2, 8.75),
					...
					new TrabajoClase(0), new TrabajoClase(0), new TrabajoClase(0)));
			daw.addAlumno(new Alumno("6", new ExamenClasico(0.1, 6), new ExamenClasico(0.2, 5.5),
					new ExamenClasico(0.2, 5), new ExamenTest(0.25, 20, 10), new ExamenTest(0.25, 19, 8),
